...
//     setLoading(true);
//     try {
//       const res = await axios.post("https://job-portal-applicant-tracking-system.onrender.com/api/auth/login", { email, password });
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await axios.post(
        "https://job-portal-applicant-tracking-system.onrender.com/api/auth/login",
        { email, password }
      );
    ...
    >
      <style>{`
        ...
        * {
        ...
        @media (max-width: 1000px) {
          ...
          .panel-feature > div:last-child > div:first-child {
            font-size: 14px !important;
          }

          .panel-feature > div:last-child > div:last-child {
      ...
      <div
        style={{
          ...
          padding: "48px 60px",
          background: "linear-gradient(145deg, #0f0a1e, #130c24)",
          borderRight: "1px solid rgba(255,255,255,0.06)",
          position: "relative",
          overflow: "hidden",
          display: "none",
      ...
      >
            ...
            {[
              {
                ...
                desc: "Personalized recommendations based on your skills",
              },
              {
                icon: "⚡",
              ...
              },
              {
                ...
                desc: "Monitor application status in your dashboard",
              },
            ].map((f) => (
              <div className="panel-feature" key={f.title}>
                <div className="panel-icon">{f.icon}</div>
        ...
        >
          ...
          >
            "Landed my dream role at a Series B startup within 3 weeks of
            signing up."
          </p>
