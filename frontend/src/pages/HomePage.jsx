  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="hero-sub">
          Connect with world-class companies. Build a career that actually
          means something.
        </p>
          ...
          {[
            {
              ...
              desc: "Partner companies range from hot startups to Fortune 500 leaders, all actively hiring.",
            },
            {
              icon: "⚡",
              title: "One-Click Apply",
              desc: "Apply to multiple roles instantly. Your profile does the heavy lifting.",
            },
            {
              icon: "🎯",
              title: "Smart Matching",
              desc: "Our algorithm surfaces roles that match your exact skills, salary range, and ambition.",
            },
            {
              icon: "📈",
              title: "Career Analytics",
              desc: "Track application success, benchmark your profile, and know your market value.",
            },
            {
              icon: "🔔",
              title: "Real-time Alerts",
              desc: "Get notified the moment a matching role drops — before the competition.",
            },
            {
              icon: "🤝",
              title: "Direct Recruiter Access",
              desc: "Message hiring managers directly. Skip the noise, make real connections.",
            },
          ].map((f) => (
            <div className="feature-card-new" key={f.title}>
              <div className="feature-icon">{f.icon}</div>
      ...
      >
        ...
        >
          <div>
            ...
            >
              Your gateway to meaningful work. Connecting ambition with
