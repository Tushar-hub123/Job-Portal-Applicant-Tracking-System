...
function Register() {
  ...
  const validateField = (field, value, currentErrors = errors) => {
    ...
    if (field === "email") {
      if (!value) newErrors.email = "Email is required";
        ...
        newErrors.email = "Enter a valid email (you@example.com)";
      else delete newErrors.email;
    }
  ...
  const handleRegister = async (e) => {
    ...
    try {
      await axios.post(
        "https://job-portal-applicant-tracking-system.onrender.com/api/auth/register",
        form
      );
  ...
  const getPasswordStrength = (password = "") => {
    ...
    if (score === 3)
      return { score, label: "Fair", color: "#fbbf24" };

    if (score === 4)
      return { score, label: "Good", color: "#34d399" };
      ...
      <style>{`
        ...
        * {
        ...
        .role-card.active {
          ...
          background: rgba(167,139,250,0.09);
          box-shadow:
            0 0 0 4px rgba(167,139,250,0.07),
        ...
        .submit-btn:hover {
          ...
          box-shadow: 0 24px 50px rgba(124,58,237,0.45);
        }
            ...
            {[
              {
                ...
                desc: "Tell us about your skills and goals",
              },
              {
                num: "02",
                title: "Discover matches",
                desc: "Curated listings tailored to you",
              },
              {
                num: "03",
                title: "Apply & connect",
                desc: "Reach hiring managers directly",
              },
            ].map((step, i) => (
              <div
                key={step.num}
