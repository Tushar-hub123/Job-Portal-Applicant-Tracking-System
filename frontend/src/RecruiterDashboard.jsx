...
//     try {
//       const res = await axios.get("https://job-portal-applicant-tracking-system.onrender.com/api/jobs/my-jobs", {
...
//     setCreating(true);
//     try {
//       await axios.post("https://job-portal-applicant-tracking-system.onrender.com/api/jobs/create", form, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     try {
//       const res = await axios.get(`https://job-portal-applicant-tracking-system.onrender.com/api/applications/job/${jobId}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//     try {
//       await axios.delete(`https://job-portal-applicant-tracking-system.onrender.com/api/jobs/${id}`, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
//       fetchJobs();
//     } catch (err) { console.log(err); }
...
//     try {
//       await axios.put(`https://job-portal-applicant-tracking-system.onrender.com/api/applications/status/${id}`, { status }, {
//         headers: { Authorization: `Bearer ${token}` },
//       });
...
//                         <a className="resume-link" href={`https://job-portal-applicant-tracking-system.onrender.com/uploads/${app.resume}`} target="_blank" rel="noreferrer">
//                           📄 Download Resume
//                         </a>
...
function RecruiterDashboard() {
  ...
  const fetchJobs = async () => {
    try {
      const res = await axios.get(
        "https://job-portal-applicant-tracking-system.onrender.com/api/jobs/my-jobs",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const createJob = async (e) => {
    ...
    try {
      await axios.post(
        "https://job-portal-applicant-tracking-system.onrender.com/api/jobs/create",
        form,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const deleteJob = async (id) => {
    try {
      await axios.delete(
        `https://job-portal-applicant-tracking-system.onrender.com/api/jobs/${id}`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const updateStatus = async (id, status) => {
    try {
      await axios.put(
        `https://job-portal-applicant-tracking-system.onrender.com/api/applications/status/${id}`,
        { status },
        {
          headers: { Authorization: `Bearer ${token}` },
        }
    ...
    >
      <style>{`
        ...
        * {
        ...
        @media (max-width: 800px) {
          ...
          .recruiter-sidebar > div:first-child {
            margin-bottom: 0 !important;
            flex-shrink: 0;
          }

          .recruiter-sidebar > div:nth-child(2) {
            flex-direction: row !important;
            align-items: center !important;
            overflow-x: auto;
            overflow-y: hidden;
          ...
          .recruiter-sidebar > div:nth-child(2) > div:first-child {
            display: none;
          }

          .recruiter-sidebar > div:nth-child(3),
          .recruiter-sidebar > div:nth-child(4) {
        ...
        @media (max-width: 600px) {
          ...
          .recruiter-sidebar > div:first-child > div:first-child {
          ...
          .recruiter-content .fade-in > div:first-child {
          ...
          .app-card > div:first-child > div:nth-child(2) {
            min-width: 0;
            flex: 1;
          }
        ...
        @media (max-width: 450px) {
          ...
          .recruiter-sidebar > div:first-child > div:nth-child(2) {
            display: none;
          }
          ...
          .recruiter-topbar > div:first-child > div {
            font-size: 10px !important;
          }
          ...
          .recruiter-content .fade-in > div:nth-child(2) {
            font-size: 12px !important;
          ...
          .job-card > div:nth-child(2) > div:first-child {
            width: 40px !important;
            height: 40px !important;
            font-size: 18px !important;
          }

          .job-card > div:nth-child(2) > div:nth-child(2) > div:first-child {
            font-size: 15px !important;
          }

          .job-card > div:nth-child(2) > div:nth-child(2) > div:nth-child(2) {
            font-size: 12px !important;
          }
          ...
          .job-card > div:last-child .action-btn {
            flex: 1;
            min-width: 120px;
          }
          ...
          .app-card > div:first-child > div:first-child {
            width: 42px !important;
            height: 42px !important;
            font-size: 16px !important;
          }

          .app-card > div:first-child > div:nth-child(2) > div:first-child {
            font-size: 14px !important;
            overflow-wrap: anywhere;
          }

          .app-card > div:first-child > div:nth-child(2) > div:nth-child(2) {
            font-size: 11px !important;
            overflow-wrap: anywhere;
          }
      ...
      >
        ...
        >
          ...
          {active === "create" && (
            <div
              className="fade-in create-job-container"
              style={{
                maxWidth: 700,
              }}
            >
              ...
              >
                Fill in the details to attract the right
                candidates
              </div>
                    ...
                    >
                      ...
                      >
                        <a
                          ...
                          href={`https://job-portal-applicant-tracking-system.onrender.com/uploads/${app.resume}`}
                          target="_blank"
                          rel="noreferrer"
                        >
                          📄 Download Resume
                        ...
                        {app.status === "Shortlisted" && (
                          <>
                            ...
                            <button
                              className="action-btn notselect-btn"
                              onClick={() =>
                                updateStatus(
                                  app._id,
                                  "Not Selected"
